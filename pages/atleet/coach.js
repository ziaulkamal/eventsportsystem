...
import { FormAtleetInsert, FormCoachInsert, FormDokumenInsert, FormUmumInsert } from "@/templates/coach/FormInsert";
import { FormCoachUpdate, FormDokumenUpdate, FormUmumUpdate } from "@/templates/coach/FormUpdate";
import TableCoach from "@/templates/coach/Table";
...
const CoachPage = () => {
    ...
    const [coachRefetchKey, setCoachRefetchKey] = useState(0);
    const dataPage = {
            ...
            <div className="row">
                <div className="col-xxl-12">
                    <div className="card">
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            <li>
                                                <Link className="dropdown-item" href="#"
                                                    ...
                                                    {showForm ? "Kembali ke Tabel Coach" : editForm ? "Kembali ke Tabel Coach" : "Tambah Coach"}
                                                </Link>
                                            </li>
                                            <li>
                                                <Link className="dropdown-item" href="#">
                        ...
                        {(!showForm && !editForm) && (
                            <TableCoach key={showForm ? "form" : "table"}  onEditClick={handleEditClick} refresh={handleRefreshTable} /> 
                        )}
                        {(showForm && !editForm) && (
                            <div className="card-body">
                                <div id="custom-progress-bar" className="progress-nav mb-4">
                                    ...
                                    <ul className="nav nav-pills progress-bar-tab custom-nav" role="tablist">
                                        ...
                                        <li className="nav-item" role="presentation">
                                            <button
                                                className={`nav-link rounded-pill ${activeTab === 'coach-form-tab' ? 'active' : ''}`}
                                                id="coach-form-tab"
                                                data-bs-toggle="pill"
                                                data-bs-target="#coach-form"
                                                type="button"
                                                role="tab"
                                                aria-controls="coach-form"
                                                aria-selected={activeTab === 'coach-form-tab'}
                                                onClick={() => handleTabChange('coach-form-tab')}
                                            >
                                                2
                                            </button>
                                        </li>
                                ...
                                <div className="tab-content">
                                    ...
                                    <div className={`tab-pane fade ${activeTab === 'coach-form-tab' ? 'show active' : ''}`} id="coach-form" role="tabpanel" aria-labelledby="coach-form-tab">
                                        <FormCoachInsert useForm={showForm} setActiveTab={setActiveTab} peopleId={peopleId} />
                                    </div>
                                ...
                                <div className="tab-content">
                                    <div className={`tab-pane fade ${activeTab === 'general-form-tab' ? 'show active' : ''}`} id="general-form" role="tabpanel" aria-labelledby="general-form-tab">
                                        <FormUmumUpdate 
                                            ...
                                            setCoachRefetchKey={setCoachRefetchKey}
                                        />
                                    </div>
                                    <div className={`tab-pane fade ${activeTab === 'coach-form-tab' ? 'show active' : ''}`} id="coach-form" role="tabpanel" aria-labelledby="coach-form-tab">
                                        <FormCoachUpdate 
                                            setActiveTab={setActiveTab} 
                                            peopleId={editId} 
                                            coachRefetchKey={coachRefetchKey}
                                        />
                                    </div>
                                    <div className={`tab-pane fade ${activeTab === 'document-form-tab' ? 'show active' : ''}`} id="document-form" role="tabpanel" aria-labelledby="document-form-tab">
