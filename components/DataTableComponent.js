...
const DataTableComponent = ({ columns, data, onEditClick, onDeleteClick, tableId = 'alternative-pagination', className = 'table nowrap dt-responsive align-middle table-hover table-bordered', style = { width: '100%' }, pagingType = 'full_numbers' }) => {
    useEffect(() => {
